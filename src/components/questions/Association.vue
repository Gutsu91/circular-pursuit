...
<p>Relier pour chaque période le nombre de vague de chaleur</p>
  ...
  <div id="yes-drop" class="drag-drop drag-drop-assoc"> 26 </div>
  <div id="yes-drop" class="drag-drop drag-drop-assoc"> 9 </div>
  <div id="yes-drop" class="drag-drop drag-drop-assoc"> 4 </div>
  <div id="yes-drop" class="drag-drop drag-drop-assoc"> 4 </div>
